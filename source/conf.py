...
# Github path
github_repo = "https://github.com/Terradue/doc-virtual-archive"
...
htmlhelp_basename = 'VirtualArchivedoc'
...
latex_documents = [
  ('index', 'VirtualArchive.tex', u'Virtual Archive Documentation',
   u'Terradue', 'manual'),
]
